...
public class TestView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        APP_PATH=ii.getStringExtra("APP_PATH");
        ...
        pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.execSQL("INSERT INTO [History](date, type, package, name, result, maxresult) VALUES ('"+date+"', 'Тест', '"+pack+"', '"+test.name+"', "+balls+", "+maxballs+")");
                Cursor c=db.rawQuery("SELECT * FROM [User]",null);
                c.moveToFirst();
                int ar=c.getInt(1);
                int ae=c.getInt(2);
                db.execSQL("UPDATE [User] SET results="+(ar+balls)+", errors="+(ae+(maxballs-balls)));
                db.close();
                }
        });
    }
