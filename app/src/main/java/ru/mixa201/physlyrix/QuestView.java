...
public class QuestView extends AppCompatActivity {
    ...
    private String pack;
    private String zz;
    private String questl;
    private String APP_PATH;
    private String packl;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zz=i.getStringExtra("QUEST");
        questl=zz;
        pack=i.getStringExtra("PACKAGE");
        packl=i.getStringExtra("PACKL");
        APP_PATH=i.getStringExtra("APP_PATH");
        Log.i("QUERY",zz+" "+pack);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("QUESTL",questl);
                i.putExtra("PACKAGE",packl);
